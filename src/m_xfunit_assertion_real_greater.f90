module m_xfunit_assertion_real_greater
...
! Synopsis  : Unit tests real range (greater than) assertion
!
...
!---Public/Private declarations-------------------------------------------------
  ...
  public t_xfunit_assertion_real_greater

  public xfunit_assertion_real_greater

!---End of public/private declarations------------------------------------------

!---Declaration of module variables---------------------------------------------

! The real range (greater than) assertion type
  type, extends(t_xfunit_assertion) :: t_xfunit_assertion_real_greater
    private
...
!     Assignment
      procedure :: xfunit_assertion_assign => xfunit_assertion_real_greater_assign

!     Serialization interface (overrides abstract base; same name required)
      procedure :: write_xml => xfunit_assertion_real_greater_write_xml
      procedure :: write => xfunit_assertion_real_greater_write

  end type t_xfunit_assertion_real_greater
...
! The returned assertion
  type(t_xfunit_assertion_real_greater) :: res
...
! Store the information
  res%t_xfunit_assertion = xfunit_assertion( name, xfunit_assertion_real_greater_index, status )
  res%actual   = actual
  res%low      = low

end function xfunit_assertion_real_greater
...
! Cast the other object
  select type(other)
    type is(t_xfunit_assertion_real_greater)
...
end subroutine xfunit_assertion_real_greater_assign


! Serialize in XML
subroutine xfunit_assertion_real_greater_write_xml( this, xml )

! The assertion
  class(t_xfunit_assertion_real_greater), intent(in) :: this
...
end subroutine xfunit_assertion_real_greater_write_xml


! Serialize in plain text
subroutine xfunit_assertion_real_greater_write( this, unit )
...
end subroutine xfunit_assertion_real_greater_write

end module m_xfunit_assertion_real_greater
