...
! The names of the tests to execute (optional)
  character(len=*), dimension(:), allocatable, intent(in) :: names

! Local variables
  type(t_string), dimension(:), allocatable :: lnames
  integer :: i
...
! The names of the tests to execute (optional)
  type(t_string), optional, dimension(:), allocatable, intent(in) :: names
