...
! Synopsis  : Unit tests integer range (less than) array assertion
!
...
function xfunit_assertion_array_integer_less_common( name, actual, high, open_high ) result(res)
...
function xfunit_assertion_array_integer_less_array( name, actual, high, open_high ) result(res)
