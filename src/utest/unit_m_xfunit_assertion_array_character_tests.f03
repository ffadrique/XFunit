module unit_m_xfunit_assertion_array_character_tests
...
! Synopsis  : Unit tests for m_xfunit_assertion_array_character
!
...
!---Public/Private declarations-------------------------------------------------
  ...
  public unit_m_xfunit_assertion_array_character_test_001

  public unit_m_xfunit_assertion_array_character_test_002

  public unit_m_xfunit_assertion_array_character_test_003

!---End of public/private declarations------------------------------------------

  character(len=*), parameter :: package = 'xfunit'
  character(len=*), parameter :: module = 'm_xfunit_assertion_array_character'
...
! Reference character variables
  character(len=*), dimension(4), parameter :: actual = [ 'Lorem ipsum dolor sit amet, ', &
                                                          'consectetur adipiscing elit.', &
                                                          'Aliquam non consequat ex,   ', &
                                                          'efficitur vestibulum mauris.' ]
  character(len=*), dimension(4), parameter :: expected = actual
...
subroutine unit_m_xfunit_assertion_array_character_test_001( ut )

! The unit test
  class(t_xfunit_unit), intent(inout) :: ut

! The tested strcuture
  type(t_xfunit_assertion_array_character) :: object
...
end subroutine unit_m_xfunit_assertion_array_character_test_001

! ############################################################################
! ############################################################################
! ############################################################################

subroutine unit_m_xfunit_assertion_array_character_test_002( ut )
...
! General interface (exact)
  call ut%assert_equal( 'General interface (exact)', actual, expected, &
                        matching=xfunit_assertion_character_match_exact )
...
! General interface (global)
  call ut%assert_equal( 'General interface (global)', actual, e, matching=xfunit_assertion_character_match_global )
...
end subroutine unit_m_xfunit_assertion_array_character_test_002

! ############################################################################
! ############################################################################
! ############################################################################

subroutine unit_m_xfunit_assertion_array_character_test_003( ut )
...
! Local variables
  integer :: status
  character(len=:), dimension(:), allocatable :: e

! Reset error handling structures
  call msg%reset_error()

! General interface
  e = uppercase(expected)
  call ut%assert_equal( 'General interface (ignorecase)', actual, e, ignorecase=.true. )

! General interface with status
  e = lowercase(expected)
  call ut%assert_equal( 'General interface (exact) with status', actual, e, ignorecase=.true., status=status )
  call ut%assert_equal( 'Status (exact)', status, xfunit_assertion_is_pass )
...
end subroutine unit_m_xfunit_assertion_array_character_test_003

end module unit_m_xfunit_assertion_array_character_tests
