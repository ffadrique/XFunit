module unit_m_xfunit_assertion_array_string_tests
...
! Synopsis  : Unit tests for m_xfunit_assertion_array_string
!
...
!---Public/Private declarations-------------------------------------------------
  ...
  public unit_m_xfunit_assertion_array_string_test_001

  public unit_m_xfunit_assertion_array_string_test_002

  public unit_m_xfunit_assertion_array_string_test_003

!---End of public/private declarations------------------------------------------

  character(len=*), parameter :: package = 'xfunit'
  character(len=*), parameter :: module = 'm_xfunit_assertion_array_string'
...
! Reference character variables
  character(len=*), dimension(4), parameter :: cactual = [ 'Lorem ipsum dolor sit amet, ', &
                                                           'consectetur adipiscing elit.', &
                                                           'Aliquam non consequat ex,   ', &
                                                           'efficitur vestibulum mauris.' ]
  character(len=*), dimension(4), parameter :: cexpected = cactual
...
subroutine unit_m_xfunit_assertion_array_string_test_001( ut )

! The unit test
  class(t_xfunit_unit), intent(inout) :: ut

! The tested strcuture
  type(t_xfunit_assertion_array_string) :: object

! Local variables
  integer :: status
  type(t_string), allocatable, dimension(:) :: actual, expected
  integer :: i
...
! Initialise
  allocate( actual(size(cactual)) )
  actual = cactual
  allocate( expected(size(cexpected)) )
  expected = [ ( string(cexpected(i)), i = 1, size(cexpected) ) ]
...
end subroutine unit_m_xfunit_assertion_array_string_test_001

! ############################################################################
! ############################################################################
! ############################################################################

subroutine unit_m_xfunit_assertion_array_string_test_002( ut )
...
! General interface (global)
  call ut%assert_equal( 'General interface (global)', actual, e, matching=xfunit_assertion_string_match_global )
...
end subroutine unit_m_xfunit_assertion_array_string_test_002

! ############################################################################
! ############################################################################
! ############################################################################

subroutine unit_m_xfunit_assertion_array_string_test_003( ut )
...
! General interface with status
  call ut%assert_equal( 'General interface (exact) with status', actual, expected%lowercase(), ignorecase=.true., status=status )
  call ut%assert_equal( 'Status (exact)', status, xfunit_assertion_is_pass )
...
end subroutine unit_m_xfunit_assertion_array_string_test_003

end module unit_m_xfunit_assertion_array_string_tests
