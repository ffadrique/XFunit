program unit_m_xfunit_assertion_real_greater
...
! Synopsis  : Unit tests driver for m_xfunit_assertion_real_greater
!
...
!---USE statements--------------------------------------------------------------
  ...
  use unit_m_xfunit_assertion_real_greater_tests
...
! Create test
  call suite%add_unit_test( xfunit_unit( name='unit_m_xfunit_assertion_real_greater_test_001', &
                                         classname='t_xfunit_assertion_real_greater', &
                                         executer=unit_m_xfunit_assertion_real_greater_test_001, &
                                         annotation='Real kind=4' ) )

! Create test
  call suite%add_unit_test( xfunit_unit( name='unit_m_xfunit_assertion_real_greater_test_002', &
                                         classname='t_xfunit_assertion_real_greater', &
                                         executer=unit_m_xfunit_assertion_real_greater_test_002, &
...
end program unit_m_xfunit_assertion_real_greater
