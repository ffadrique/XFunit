program unit_m_xfunit_assertion_string
...
! Synopsis  : Unit tests driver for m_xfunit_assertion_string
!
...
!---USE statements--------------------------------------------------------------
  ...
  use unit_m_xfunit_assertion_string_tests
...
! Create test
  call suite%add_unit_test( xfunit_unit( name='unit_m_xfunit_assertion_string_test_001', &
                                         classname='t_xfunit_assertion_string', &
                                         executer=unit_m_xfunit_assertion_string_test_001, &
                                         annotation='General interface' ) )

! Create test
  call suite%add_unit_test( xfunit_unit( name='unit_m_xfunit_assertion_string_test_002', &
                                         classname='t_xfunit_assertion_string', &
                                         executer=unit_m_xfunit_assertion_string_test_002, &
                                         annotation='Matching strategies' ) )

! Create test
  call suite%add_unit_test( xfunit_unit( name='unit_m_xfunit_assertion_string_test_003', &
                                         classname='t_xfunit_assertion_string', &
                                         executer=unit_m_xfunit_assertion_string_test_003, &
...
end program unit_m_xfunit_assertion_string
