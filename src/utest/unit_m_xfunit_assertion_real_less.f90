program unit_m_xfunit_assertion_real_less
...
! Synopsis  : Unit tests driver for m_xfunit_assertion_real_less
!
...
!---USE statements--------------------------------------------------------------
  ...
  use unit_m_xfunit_assertion_real_less_tests
...
! Initialise test suite
  ...
  suite = xfunit_suite( package=package, &
                        source='m_xfunit_assertion_real_less.f90', &
                        annotation='Assertion interface for real less values' )

! Create test
  call suite%add_unit_test( xfunit_unit( name='unit_m_xfunit_assertion_real_less_test_001', &
                                         classname='t_xfunit_assertion_real_less', &
                                         executer=unit_m_xfunit_assertion_real_less_test_001, &
                                         annotation='Real kind=4' ) )

! Create test
  call suite%add_unit_test( xfunit_unit( name='unit_m_xfunit_assertion_real_less_test_002', &
                                         classname='t_xfunit_assertion_real_less', &
                                         executer=unit_m_xfunit_assertion_real_less_test_002, &
...
end program unit_m_xfunit_assertion_real_less
