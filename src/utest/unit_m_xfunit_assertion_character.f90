program unit_m_xfunit_assertion_character
...
! Synopsis  : Unit tests driver for m_xfunit_assertion_character
!
...
!---USE statements--------------------------------------------------------------
  ...
  use unit_m_xfunit_assertion_character_tests
...
! Initialise test suite
  ...
  suite = xfunit_suite( package=package, &
                        source='m_xfunit_assertion_character.f90', &
                        annotation='Assertion interface for character' )

! Create test
  call suite%add_unit_test( xfunit_unit( name='unit_m_xfunit_assertion_character_test_001', &
                                         classname='t_xfunit_assertion_character', &
                                         executer=unit_m_xfunit_assertion_character_test_001, &
                                         annotation='General interface' ) )

! Create test
  call suite%add_unit_test( xfunit_unit( name='unit_m_xfunit_assertion_character_test_002', &
                                         classname='t_xfunit_assertion_character', &
                                         executer=unit_m_xfunit_assertion_character_test_002, &
                                         annotation='Matching strategies' ) )

! Create test
  call suite%add_unit_test( xfunit_unit( name='unit_m_xfunit_assertion_character_test_003', &
                                         classname='t_xfunit_assertion_character', &
                                         executer=unit_m_xfunit_assertion_character_test_003, &
...
end program unit_m_xfunit_assertion_character
