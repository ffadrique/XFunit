program unit_m_xfunit_assertion_logical
...
! Synopsis  : Unit tests driver for m_xfunit_assertion_logical
!
...
!---USE statements--------------------------------------------------------------
  ...
  use unit_m_xfunit_assertion_logical_tests
...
! Create test
  call suite%add_unit_test( xfunit_unit( name='unit_m_xfunit_assertion_logical_test_001', &
                                         classname='t_xfunit_assertion_logical', &
                                         executer=unit_m_xfunit_assertion_logical_test_001, &
                                         annotation='Logical kind=1' ) )

! Create test
  call suite%add_unit_test( xfunit_unit( name='unit_m_xfunit_assertion_logical_test_002', &
                                         classname='t_xfunit_assertion_logical', &
                                         executer=unit_m_xfunit_assertion_logical_test_002, &
                                         annotation='Logical kind=2' ) )

! Create test
  call suite%add_unit_test( xfunit_unit( name='unit_m_xfunit_assertion_logical_test_003', &
                                         classname='t_xfunit_assertion_logical', &
                                         executer=unit_m_xfunit_assertion_logical_test_003, &
                                         annotation='Logical kind=4' ) )
...
end program unit_m_xfunit_assertion_logical
