program unit_m_xfunit_assertion_write
...
! Synopsis  : Unit tests driver for m_xfunit_assertion_write
!
...
!---USE statements--------------------------------------------------------------
  ...
  use unit_m_xfunit_assertion_write_tests
...
! Create test
  call suite%add_unit_test( xfunit_unit( name='unit_m_xfunit_assertion_write_test_001', &
                                         classname='t_xfunit_assertion_files', &
                                         executer=unit_m_xfunit_assertion_write_test_001, &
                                         before=unit_m_xfunit_assertion_write_before_001, &
                                         after=unit_m_xfunit_assertion_write_after_001, &
                                         annotation='All classes text writers' ) )
...
end program unit_m_xfunit_assertion_write
