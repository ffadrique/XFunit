module unit_m_xfunit_assertion_array_class_tests
...
! Synopsis  : Unit tests for m_xfunit_assertion_array_class
!
...
!---Public/Private declarations-------------------------------------------------
  ...
  public unit_m_xfunit_assertion_array_class_suite_before

  public unit_m_xfunit_assertion_array_class_test_001

  public unit_m_xfunit_assertion_array_class_test_002

  public unit_m_xfunit_assertion_array_class_test_003

  public unit_m_xfunit_assertion_array_class_test_004

!---End of public/private declarations------------------------------------------

  character(len=*), parameter :: package = 'xfunit'
  character(len=*), parameter :: module = 'm_xfunit_assertion_array_class'
...
! Test variables
  ...
  type(t_test), parameter, dimension(6) :: expected = &
             [ t_test( 1, 1.0, 'One'), &
               t_test( 2, 2.0, 'Two'), &
               t_test( 3, 3.0, 'Three'), &
               t_test( 4, 4.0, 'Four'), &
               t_test( 5, 5.0, 'Five'), &
               t_test( 6, 6.0, 'Six') ]
  type(t_test), dimension(6), save :: actual0
  type(t_test), dimension(6), save :: actual
...
subroutine unit_m_xfunit_assertion_array_class_test_001( ut )

! The unit test
  class(t_xfunit_unit), intent(inout) :: ut

! The tested strcuture
  type(t_xfunit_assertion_array_class) :: object
...
end subroutine unit_m_xfunit_assertion_array_class_test_001

! ############################################################################
! ############################################################################
! ############################################################################

subroutine unit_m_xfunit_assertion_array_class_test_002( ut )
...
end subroutine unit_m_xfunit_assertion_array_class_test_002

! ############################################################################
! ############################################################################
! ############################################################################

subroutine unit_m_xfunit_assertion_array_class_test_003( ut )
...
end subroutine unit_m_xfunit_assertion_array_class_test_003

! ############################################################################
! ############################################################################
! ############################################################################

subroutine unit_m_xfunit_assertion_array_class_test_004( ut )
...
end subroutine unit_m_xfunit_assertion_array_class_test_004

! ############################################################################
! # Suite before procedure ###################################################
! ############################################################################

subroutine unit_m_xfunit_assertion_array_class_suite_before( suite )
...
end subroutine unit_m_xfunit_assertion_array_class_suite_before

end module unit_m_xfunit_assertion_array_class_tests
