module unit_m_xfunit_assertion_array_real_between_tests
...
! Synopsis  : Unit tests for m_xfunit_assertion_array_real_between
!
...
!---Public/Private declarations-------------------------------------------------
  ...
  public unit_m_xfunit_assertion_array_real_between_test_001

  public unit_m_xfunit_assertion_array_real_between_test_002

  public unit_m_xfunit_assertion_array_real_between_test_003

  public unit_m_xfunit_assertion_array_real_between_test_004

!---End of public/private declarations------------------------------------------

  character(len=*), parameter :: package = 'xfunit'
  character(len=*), parameter :: module = 'm_xfunit_assertion_array_real_between'
...
subroutine unit_m_xfunit_assertion_array_real_between_test_001( ut )

! The unit test
  class(t_xfunit_unit), intent(inout) :: ut

! The tested strcuture
  type(t_xfunit_assertion_array_real_between) :: object
...
end subroutine unit_m_xfunit_assertion_array_real_between_test_001

! ############################################################################
! ############################################################################
! ############################################################################

subroutine unit_m_xfunit_assertion_array_real_between_test_002( ut )
...
end subroutine unit_m_xfunit_assertion_array_real_between_test_002

! ############################################################################
! ############################################################################
! ############################################################################

subroutine unit_m_xfunit_assertion_array_real_between_test_003( ut )
...
! General interface
  call ut%assert_between( 'General interface', &
                          [ 2.0_8, 2.0_8, 2.0_8, 2.0_8 ], &
                          [ 1.0_8, 1.0_8, 1.0_8, 1.0_8 ], &
                          [ 3.0_8, 3.0_8, 3.0_8, 3.0_8 ] )
  call ut%assert_between( 'General interface (low bound)', &
                          [ 1.0_8, 1.0_8, 1.0_8, 1.0_8 ], &
                          [ 1.0_8, 1.0_8, 1.0_8, 1.0_8 ], &
                          [ 3.0_8, 3.0_8, 3.0_8, 3.0_8 ] )
...
end subroutine unit_m_xfunit_assertion_array_real_between_test_003

! ############################################################################
! ############################################################################
! ############################################################################

subroutine unit_m_xfunit_assertion_array_real_between_test_004( ut )
...
end subroutine unit_m_xfunit_assertion_array_real_between_test_004

end module unit_m_xfunit_assertion_array_real_between_tests
