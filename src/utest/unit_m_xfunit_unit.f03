...
! Synopsis  : Unit tests driver for m_xfunit_unit
!
...
! Initialise test suite
  suite = xfunit_suite( package=package, &
                       source='m_xfunit_unit.f90', &
                       annotation='' )

! Create test
  ut = xfunit_unit( name='unit_m_xfunit_unit_test_001', &
                    classname="t_xfunit_unit", &
                    executer=unit_m_xfunit_unit_test_001, &
                    annotation='' )
  call suite%add_unit_test( ut )

! Create test
  ut = xfunit_unit( name='unit_m_xfunit_unit_test_002', &
                    classname="t_xfunit_unit", &
                    executer=unit_m_xfunit_unit_test_002, &
                    annotation='' )
  call suite%add_unit_test( ut )

! Create test
  ut = xfunit_unit( name='unit_m_xfunit_unit_test_003', &
                    classname="t_xfunit_unit", &
                    executer=unit_m_xfunit_unit_test_003, &
                    annotation='' )
  call suite%add_unit_test( ut )
...
end program unit_m_xfunit_unit
