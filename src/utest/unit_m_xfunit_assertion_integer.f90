program unit_m_xfunit_assertion_integer
...
! Synopsis  : Unit tests driver for m_xfunit_assertion_integer
!
...
!---USE statements--------------------------------------------------------------
  ...
  use unit_m_xfunit_assertion_integer_tests
...
! Initialise test suite
  ...
  suite = xfunit_suite( package=package, &
                        source='m_xfunit_assertion_integer.f90', &
                        annotation='Assertion interface for integer' )

! Create test
  call suite%add_unit_test( xfunit_unit( name='unit_m_xfunit_assertion_integer_test_001', &
                                         classname='t_xfunit_assertion_integer', &
                                         executer=unit_m_xfunit_assertion_integer_test_001, &
                                         annotation='Integer kind=1' ) )

! Create test
  call suite%add_unit_test( xfunit_unit( name='unit_m_xfunit_assertion_integer_test_002', &
                                         classname='t_xfunit_assertion_integer', &
                                         executer=unit_m_xfunit_assertion_integer_test_002, &
                                         annotation='Integer kind=2' ) )

! Create test
  call suite%add_unit_test( xfunit_unit( name='unit_m_xfunit_assertion_integer_test_003', &
                                         classname='t_xfunit_assertion_integer', &
                                         executer=unit_m_xfunit_assertion_integer_test_003, &
                                         annotation='Integer kind=4' ) )

! Create test
  call suite%add_unit_test( xfunit_unit( name='unit_m_xfunit_assertion_integer_test_004', &
                                         classname='t_xfunit_assertion_integer', &
                                         executer=unit_m_xfunit_assertion_integer_test_004, &
...
end program unit_m_xfunit_assertion_integer
