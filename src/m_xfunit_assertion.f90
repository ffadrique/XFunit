...
! Synopsis  : Unit tests assertion parent type
!
...
!     Interface (deferred) defintion for XML serialization
      procedure :: write_xml_start_tag => xfunit_assertion_write_start_tag
      procedure :: write_xml => xfunit_assertion_write_xml
      procedure, nopass :: write_xml_end_tag => xfunit_assertion_write_end_tag

!     Interface (deferred) defintion for text serialization
      procedure :: write_header => xfunit_assertion_write_header
      procedure :: write => xfunit_assertion_write
      procedure, nopass :: write_footer => xfunit_assertion_write_footer
...
subroutine xfunit_assertion_write_start_tag( this, xml )
...
end subroutine xfunit_assertion_write_start_tag


! Serialize in XML the end common section of the assertion
subroutine xfunit_assertion_write_end_tag( xml )
...
end subroutine xfunit_assertion_write_end_tag


! Serialize in plain text the start common section of the assertion
subroutine xfunit_assertion_write_header( this, unit )
...
end subroutine xfunit_assertion_write_header


! Serialize in plain text the end common section of the assertion
subroutine xfunit_assertion_write_footer( unit )
...
end subroutine xfunit_assertion_write_footer
