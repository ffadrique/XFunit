...
! Synopsis  : Uunit tests array assertion parent type
!
...
function xfunit_assertion_array( name, type, rast, mold ) result(res)
...
! Assignment
impure elemental subroutine xfunit_assertion_array_assign( this, other )
