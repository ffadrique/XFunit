...
!>Unit tests real range assertion
!-------------------------------------------------------------------------------
...
elemental function xfunit_assertion_real_between( name, actual, low, high, open_low, open_high ) result(res)
...
!> Assignment
elemental subroutine xfunit_assertion_real_between_assign( this, other )
