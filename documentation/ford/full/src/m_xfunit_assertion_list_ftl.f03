...
!>Double linked list container template
!>             Limitations with repsect to STL C++
!>              - No reverse iteration.
!>              - No constant iterators.
!>              - Max size is dummy (dummy value not computed from archivteture).
...
!---Public/Private declarations-------------------------------------------------
  ...
  public t_xfunit_assertion_list_ftl, xfunit_assertion_list_ftl
  public t_xfunit_assertion_list_ftl_iterator
...
!>   The element data instance
    class(t_xfunit_assertion), pointer :: element => null()
...
!> Double linked list container type
  type, extends(t_object) :: t_xfunit_assertion_list_ftl
    private
...
!     Destructor
  ...
  end type t_xfunit_assertion_list_ftl


!> Constructor interface
  interface xfunit_assertion_list_ftl
  ...
  end interface xfunit_assertion_list_ftl
...
! Interface to provide user comparison functions
  abstract interface
    pure function comparison( from_list, reference ) result(res)
      use m_xfunit_assertion
      class(t_xfunit_assertion), intent(in) :: from_list
      class(t_xfunit_assertion), intent(in) :: reference
      logical :: res
...
! Interface to provide predicate algorithm to the contained element
  abstract interface
    pure function predicate( a ) result(res)
      use m_xfunit_assertion
      class(t_xfunit_assertion), intent(in) :: a
      logical :: res
...
! Interface to provide binary predicate algorithm to the contained elements
  abstract interface
    pure function binary_predicate( a, b ) result(res)
      use m_xfunit_assertion
      class(t_xfunit_assertion), intent(in) :: a
      class(t_xfunit_assertion), intent(in) :: b
      logical :: res
...
!> Double linked list iterator type
  type, extends(t_object) :: t_xfunit_assertion_list_ftl_iterator
    private
...
!     Comparison operators
  ...
  end type t_xfunit_assertion_list_ftl_iterator
...
! The result list
  type(t_xfunit_assertion_list_ftl) :: res
...
!> The element to use to fill the list
  class(t_xfunit_assertion), intent(in) :: val
...
!> Iterator to first node to insert
  class(t_xfunit_assertion_list_ftl_iterator), intent(in) :: first

!> Iterator to last node to insert
  class(t_xfunit_assertion_list_ftl_iterator), intent(in) :: last
...
!> The input list
  type(t_xfunit_assertion_list_ftl), intent(in) :: other
...
!> The input array
  class(t_xfunit_assertion), dimension(:), intent(in) :: val
...
!> The output list
  class(t_xfunit_assertion_list_ftl), intent(out) :: this

!> The input list
  class(t_xfunit_assertion_list_ftl), intent(in) :: other
...
!> The list
  class(t_xfunit_assertion_list_ftl), target, intent(in) :: this

!> Pointer to beginning of the list
  type(t_xfunit_assertion_list_ftl_iterator) :: res
...
!> The list
  class(t_xfunit_assertion_list_ftl), intent(in) :: this
...
!> Pointer to the element in the first node in the list
  class(t_xfunit_assertion), allocatable :: res
...
!> Iterator to node used as reference for insertion
  class(t_xfunit_assertion_list_ftl_iterator), intent(in) :: iterator
...
!> Iterator to node used as reference for insertion
  type(t_xfunit_assertion_list_ftl_iterator), intent(in) :: iterator
...
!> Iterator to node to remove
  class(t_xfunit_assertion_list_ftl_iterator), intent(inout) :: iterator
...
!> The list to swap
  type(t_xfunit_assertion_list_ftl), intent(inout) :: other
...
!> The element to use to initialise traling elements
  class(t_xfunit_assertion), optional, target, intent(in) :: val

! Local variables
  integer :: i
  class(t_xfunit_assertion), pointer :: init
  class(t_xfunit_assertion), allocatable, target :: default
...
!> The object to replace
  class(t_xfunit_assertion), pointer :: res
...
!> The position in list to insert the elements
  class(t_xfunit_assertion_list_ftl_iterator), intent(in) :: position

!> The source list
  class(t_xfunit_assertion_list_ftl), intent(inout) :: source
...
!> The element position in source
  class(t_xfunit_assertion_list_ftl_iterator), intent(in) :: it
...
! Local iterators
  type(t_xfunit_assertion_list_ftl_iterator) :: it, itnext
...
!> The list
  class(t_xfunit_assertion_list_ftl), target, intent(inout) :: this
...
!> The list to merge
  type(t_xfunit_assertion_list_ftl), target, intent(inout) :: other
...
! Local pointers
  ...
  class(t_xfunit_assertion), pointer :: ref, ele
...
! Intermediate pointer
  class(t_xfunit_assertion), pointer :: tmp
...
!> Iterator to first element
  class(t_xfunit_assertion_list_ftl_iterator), intent(inout) :: iter1

!> Iterator to second element
  class(t_xfunit_assertion_list_ftl_iterator), intent(inout) :: iter2
...
!> The element to look for
  class(t_xfunit_assertion), intent(in) :: item
...
! Local pointers
  ...
  class(t_xfunit_assertion), pointer :: ref
...
!> The returned array of elements (unallocated if memory failure)
  class(t_xfunit_assertion), allocatable, dimension(:) :: res
...
!> Element to be allocated and assigned (pointer interface)
  class(t_xfunit_assertion), pointer, intent(inout) :: left
...
!> Element to be allocated and assigned (allocatable interface)
  class(t_xfunit_assertion), allocatable, intent(inout) :: left
...
!> The list iterator
  class(t_xfunit_assertion_list_ftl_iterator), intent(in) :: this
...
!> The final list iterator
  class(t_xfunit_assertion_list_ftl_iterator), intent(in) :: target
...
!> The list iterator
  class(t_xfunit_assertion_list_ftl_iterator), intent(inout) :: this
...
!> The output iterator
  class(t_xfunit_assertion_list_ftl_iterator), intent(out) :: left

!> The input iterator
  class(t_xfunit_assertion_list_ftl_iterator), intent(in) :: right
...
!> The first iterator
  class(t_xfunit_assertion_list_ftl_iterator), intent(in) :: left
